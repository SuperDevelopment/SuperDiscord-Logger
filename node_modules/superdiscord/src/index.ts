...
export default class SuperDiscord extends EventEmitter {
  ...
  private async setUp(client: Client, options?: Options) {
    ...
    if (mongoUri) {
      ...
      if (showWarns) {
        console.warn(
          'SuperDiscord : No MongoDB connection URI provided. Some features might not work! See this for more details:\nhttps://docs.wornoffkeys.com/databases/mongodb'
        )
      }
    ...
    if (
      ...
      throw new Error(
        "SuperDiscord : The 'commands' directory must be an absolute path. This can be done by using the 'path' module. More info: https://docs.wornoffkeys.com/setup-and-options-object"
      )
    }
    ...
    if (
      ...
      throw new Error(
        "SuperDiscord : The 'features' directory must be an absolute path. This can be done by using the 'path' module. More info: https://docs.wornoffkeys.com/setup-and-options-object"
      )
    }
    ...
    console.log('SuperDiscord : Your bot is now running.')
  }

  public setMongoPath(mongoPath: string | undefined): SuperDiscord {
    console.warn(
      'SuperDiscord : .setMongoPath() no longer works as expected. Please pass in your mongo URI as a "mongoUri" property using the options object. For more information: https://docs.wornoffkeys.com/databases/mongodb'
    )
    return this
  }
  ...
  public setDisplayName(displayName: string): SuperDiscord {
  ...
  public setDefaultPrefix(defaultPrefix: string): SuperDiscord {
  ...
  public setPrefix(guild: Guild | null, prefix: string): SuperDiscord {
    if (guild) {
  ...
  public setColor(color: ColorResolvable | null): SuperDiscord {
    this._color = color
    return this
  }
  ...
  public setCategorySettings(category: ICategorySetting[]): SuperDiscord {
    for (let { emoji, name, hidden, customEmoji } of category) {
      ...
      if (this.isEmojiUsed(targetEmoji)) {
        console.warn(
          `SuperDiscord : The emoji "${targetEmoji}" for category "${name}" is already used.`
        )
      }
  ...
  public setTagPeople(tagPeople: boolean): SuperDiscord {
  ...
  public setBotOwner(botOwner: string | string[]): SuperDiscord {
    console.log(
      'SuperDiscord : setBotOwner() is deprecated. Please specify your bot owners in the object constructor instead. See https://docs.wornoffkeys.com/setup-and-options-object'
    )
  ...
  public setDefaultLanguage(defaultLanguage: string): SuperDiscord {
