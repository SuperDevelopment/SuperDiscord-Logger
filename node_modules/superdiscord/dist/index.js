...
class SuperDiscord extends events_1.EventEmitter {
    _client;
    _defaultPrefix = '!';
    ...
    async setUp(client, options) {
        ...
        if (mongoUri) {
            ...
            if (showWarns) {
                console.warn('SuperDiscord : No MongoDB connection URI provided. Some features might not work! See this for more details:\nhttps://docs.wornoffkeys.com/databases/mongodb');
            }
        ...
        if (this._commandsDir &&
            ...
            throw new Error("SuperDiscord : The 'commands' directory must be an absolute path. This can be done by using the 'path' module. More info: https://docs.wornoffkeys.com/setup-and-options-object");
        }
        if (this._featuresDir &&
            !(this._featuresDir.includes('/') || this._featuresDir.includes('\\'))) {
            throw new Error("SuperDiscord : The 'features' directory must be an absolute path. This can be done by using the 'path' module. More info: https://docs.wornoffkeys.com/setup-and-options-object");
        }
        if (testServers) {
    ...
    setMongoPath(mongoPath) {
        console.warn('SuperDiscord : .setMongoPath() no longer works as expected. Please pass in your mongo URI as a "mongoUri" property using the options object. For more information: https://docs.wornoffkeys.com/databases/mongodb');
        return this;
    }
    get client() {
        return this._client;
    ...
    setCategorySettings(category) {
        for (let { emoji, name, hidden, customEmoji } of category) {
            ...
            if (this.isEmojiUsed(targetEmoji)) {
                console.warn(`SuperDiscord : The emoji "${targetEmoji}" for category "${name}" is already used.`);
            }
    ...
    setBotOwner(botOwner) {
        console.log('SuperDiscord : setBotOwner() is deprecated. Please specify your bot owners in the object constructor instead. See https://docs.wornoffkeys.com/setup-and-options-object');
